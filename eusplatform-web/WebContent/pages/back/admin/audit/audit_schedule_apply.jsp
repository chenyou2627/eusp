...
<%!
	public static final String SCHEDULE_AUDIT_URL = "pages/back/admin/schedule/ScheduleActionFront!add.action" ;
%>
...
<body class="hold-transition skin-blue sidebar-mini"> 
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div style="display:none" id="flag">${param.flag }</div>
